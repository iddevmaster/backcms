  ...
  <div class="row mb-4">
    <div class="col-sm-6">
      <label for="exampleFormControlInput1">ap_date_start</label>
            <VueDatePicker v-model="store.forminsert.ap_date_start"    required></VueDatePicker>
    ...
    <div class="col-sm-6">
      <label for="exampleFormControlInput1">ap_date_end</label>
          ...
          <VueDatePicker v-model="store.forminsert.ap_date_end"  required></VueDatePicker>
...
store.forminsert.ap_date_start = isoString.slice(0, -5);


//store.forminsert.start_date = moment(date).format('YYYY-MM-DD')
 return date;
}

const format_end = (date) => {
const isoString = date.toISOString();
store.forminsert.ap_date_end = isoString.slice(0, -5);
