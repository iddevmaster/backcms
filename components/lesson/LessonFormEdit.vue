...
const downloadMe = (item) => {
 
  const pdfUrl = ApiService.image(item); // Path to your PDF file
...
const router = useRouter();
    return {
      ...
      fileInputRef,
      remove,
      onFileChangeBack,coverimage,locale,removeImage,router,downloadMe,backtoLean
    };
  },
});
</script>