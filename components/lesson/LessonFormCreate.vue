        ...
        <div class="col-xl-12">
          <div class="widget-content widget-content-area br-8 p-4">
            ...
            <div class="col-md-12 mt-3">
              ...
              ><span class="text-xs text-red-500" style="color: red"> * </span>
...
export default defineComponent({
  ...
  setup() {
    ...
    const savedata = async () => {
      validateAllFields();
      if (
        formErrors.cs_name_lo == true &&
        formErrors.cs_name_eng == true &&
        formErrors.cg_id == true &&
        formErrors.cs_description == true
      ) {
        Swal.fire({
