  ...
  <div v-if="store.GetopenModalEdit" class="modal">
    ...
    <div class="modal-content modal-dialog modal-xl" id="deleteConformationLabel">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="recipient-name" v-model="store.formcreatelessonedit.cs_name"  placeholder="ຄໍາຖາມ *">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="recipient-name" v-model="store.formcreatelessonedit.cs_description"  placeholder="ຄໍາຕອບ *">
            ...
            <input type="text" class="form-control" id="recipient-name" v-model="store.formcreatelessonedit.cs_video" placeholder="https://youtu.be/DCh2jlZzC1g *">
          ...
          <div class="border p-2 mt-3">
            ...
            <template v-if="store.formcreatelessonedit.cs_cover">
              <div class="row">
                <div class="col-3">
                  <img :src="image(store.formcreatelessonedit.cs_cover)" class="img-fluid" />
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" @click="update()">{{ $t("menu_exam_modal_save") }}</button>
      </div>
    </div>
  </div>
</template>
