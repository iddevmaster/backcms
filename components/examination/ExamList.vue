...
<span>Showing {{ (store.examques_current_page - 1 ) * store.formsearchexamques.per_page + 1}}  to {{ Math.min(store.examques_current_page * store.formsearchexamques.per_page, store.examques_total)}}  of {{store.examques_total}} entries</span>

<div class="dt--pagination" v-if="store.examques_total > 1">
  <div
  ...
  >
    <ul class="pagination">
      ...
      <li
        ...
        v-for="page in store.examques_total_page"
        :key="page"
      >
        <a
          href="#"
          ...
          tabindex="0"
          class="page-link"
          :class="{ bgcx: page === store.formsearchexamques.page }"
