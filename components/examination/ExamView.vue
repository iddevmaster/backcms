  ...
  <div id="content" class="main-content">
    ...
    <div class="layout-px-spacing">
      ...
      <div class="row layout-top-spacing">
        ...
        <select class="form-control" v-model="store.cg_id"  @change="selecttype($event)"  readonly >
          <option v-for="(item, index) in store.group" :key="item.cg_id" :value="item.cg_id" >
            {{ locale == "la" ? item.cg_name_lo : item.cg_name_eng }}
                    ...
                    <div class="col-md-12 mt-3">
                      ...
                      <select class="form-control" v-model="store.formExamqedit.eq_answer"  readonly >
          <option :value="1">
            ກ
          </option>
          <option :value="2">
