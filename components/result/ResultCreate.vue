<template>
  <div class="row mb-4">
    ...
    <div class="col-sm-6">
      <label for="exampleFormControlInput1">Mr Score</label>
      ...
      v-model="store.formresult.mr_score" :class="{
        ...
        }" @change="v$.mr_score.$touch" autocomplete="off" 
      >
    ...
    <div class="col-sm-6">
      <label for="exampleFormControlInput1">Mr learn</label>
  ...
  <div class="row mb-4">
    ...
    <div class="col-sm-6">
      <label for="exampleFormControlInput1">Mr Status</label>
  ...
  <div class="row mb-4">
    <div class="col-sm-6">
      ...
      <Select2 v-model="store.formresult.user_id" :options="myOptionsUser" :settings="{ settingOption: value, settingOption: value }"  @change="myChangeEvent($event)" @select="mySelectEvent($event)"/>
    </div>
    <span class="text-xs text-red-500" style="color:red" v-if="v$.user_id.$error">{{
        v$.user_id.$errors[0].$message
      }}</span>
  </div>
{{ store.formresult.user_id }}
