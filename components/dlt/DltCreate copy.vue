    ...
    <div class="invoice-content">
      <div class="invoice-detail-body">
        <div class="invoice-detail mb-5" style="padding: 0 48px">
          ...
          <!-- <div    v-for="(item, index) in storeapp.dlt"
              :key="index"
        ...
        />
        <label :for="item.value">{{ item.dlt_code }}</label>
      </div> -->

      <div class="form-check form-check-primary form-check-inline"  v-for="(item, index) in storeapp.dlt">
