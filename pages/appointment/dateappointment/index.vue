...
await store.fetchProv();
await store.fetchGroupProvs();
...
const selectshowdata = async (cg) => {

store.proivall_id = cg.target.value
await store.fetchGroupProvs();
};

const Fitter = async (cg) => {
  await store.fetchAppPresentTodayReset();
await store.fetchAppPresentToday();
await store.fetchAppCourse();
...
<template>
  ...
  <div id="content" class="main-content" v-if="auth.users.user_type == 1">
      ...
      <div class="middle-content container-xxl p-0">
        <div class="row layout-top-spacing">
          <div class="col-xl-2 col-lg-2 col-sm-12 layout-spacing">
            <select class="form-control" v-if="store.proviall.length > 0" @change="selectshowdata($event)">
<option v-for="(item, index) in store.proviall" :key="item.province_code" :value="item.province_code" >
  <span>{{ item.province_name }}</span>
          ...
          <div class="col-xl-2 col-lg-2 col-sm-12 layout-spacing">
            <select class="form-control" v-if="store.progroud.length > 0" v-model="store.grouppro_id">
<option v-for="(itemx, index) in store.progroud" :key="itemx.group_id" :value="itemx.group_id" >
...
"
      ...
      />
          ...
          <div class="col-xl-3 col-lg-3 col-sm-12 layout-spacing"></div>
...
/>
        ...
        <div id="toggleAccordion" class="no-icons accordion" v-if="store.dlttoday">
          <!-- A 1-->
  ...
  <div id="content" class="main-content" v-if="auth.users.user_type == 2">
    <div class="layout-px-spacing">
      <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
          <ol class="breadcrumb">
