...
<div class="modal-content modal-dialog modal-xl" id="deleteConformationLabel">
        ...
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="recipient-name" v-model="store.formexam.em_random_amount">
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="recipient-name" v-model="store.formexam.em_time">
          </div>
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Exam cover:</label>
            <input type="text" class="form-control" id="recipient-name" v-model="store.formexam.em_cover">
          </div>
        </form>
      </div>

                                <div class="modal-footer">
                <button class="btn btn btn-light-dark" data-bs-dismiss="modal"><i class="flaticon-cancel-12" @click="closeModal"></i> Discard</button>
