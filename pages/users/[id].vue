...
const RandomPassword = () => {
  ...
  store.formeditapeple.user_password = r;
};
...
">
    ...
    <option value="3">{{ $t("menu_user_c_type_user_user") }}</option>
                ...
                <div class="col-xl-3  mt-3">
                  <div class="login__form">
                    <label class="form__label"
                      >{{ $t("menu_user_c_status") }}<span class="text-xs text-red-500" style="color: red"
                        >*</span
                      ></label
                    >
                ...
                <div class="col-xl-12 mt-3">
                  <div class="login__form">
                    <button type="button" class="btn btn-primary" style="width: 100%;" @click="updated()">   {{
